...
def convert_voc_to_custom_json_ksf_plate_type(voc_dir, output_json, 
                                              label_file='',
                                              add_parent_dir_name=True):
    """
    Not completed yet
    ...
    for xml_path in xml_list:
        ...
        for obj in root.findall('object'):
            ...
            if label not in plate_label_map:
                continue
            ...
            class_ids.append(plate_label_map[label])
            box_list.append(bbox)
...
def convert_voc_to_custom_json_ksf_char_detection_and_recognition(voc_dir, 
...
def convert_voc_to_custom_json_ksf_char_detection_and_recognition_with_type(
                                                    voc_dir, 
                                                    output_dir, output_json, 
                                                    output_image_dir_name,
                                                    label_map_json,
...
if __name__ == '__main__':
    ...
    #     voc_dir='/Users/rudy/Desktop/Development/dataset/license_plate/dataset/labeled/char_detection/custom_json/artoa_char_det',
    #     output_json='/Users/rudy/Desktop/Development/dataset/license_plate/dataset/labeled/char_detection/custom_json/artoa_total.json', 
    #     add_parent_dir_name=True
    # )
    ...
    convert_voc_to_custom_json_ksf_char_detection_and_recognition(
        voc_dir='/Users/rudy/Desktop/Development/dataset/license_plate/dataset/labeled/ksf_image_02462', 
        output_dir='/Users/rudy/Desktop/Development/dataset/license_plate/dataset/labeled/char_detection_and_recognition/custom_json/',
        output_json='/Users/rudy/Desktop/Development/dataset/license_plate/dataset/labeled/char_detection_and_recognition/custom_json/total.json', 
        output_image_dir_name='ksf_image_02462',
        label_map_json='/Users/rudy/Desktop/Development/dataset/license_plate/dataset/labeled/char_detection_and_recognition/custom_json/label_map.json',
        label_info_json='/Users/rudy/Desktop/Development/dataset/license_plate/dataset/labeled/char_detection_and_recognition/custom_json/label_info.json'
    )
